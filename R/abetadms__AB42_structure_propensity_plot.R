...
#' @export
#' @import data.table
abetadms__AB42_structure_propensity_plot <- function(
	kernel_scores,
  outpath,
  colour_scheme,
  pdb_names,
  ...
  suppressWarnings(suppressMessages(ggplot2::ggsave(file=outpath, width=width, height=height, useDingbats=FALSE)))
}
